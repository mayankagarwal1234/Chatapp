...
const SaarthiMain = ({ loading, prompt, setPrompt, handleAsk }) => {
  ...
  return (
    <div className="flex flex-col bg-blue-400/15 h-screen text-black relative">
      ...
      <form
        onSubmit={handleAsk}
        className="absolute bottom-0 left-0 right-0 z-10 px-2 sm:px-4 py-1"
      >
        <div className="max-w-8xl mx-auto flex rounded-xl px-4 py-1 bg-[#f6f7f9] shadow-inner border border-gray-300">
